...
$outputPath = "C:\DSC\Forest"


$pwd = ConvertTo-SecureString "P@assword!" -AsPlainText -Force
$creds = New-Object System.Management.Automation.PSCredential ("teppeiy", $pwd)


Forest -ConfigurationData $ConfigData -OutputPath $outputPath `
    -safemodeAdministratorCred $creds `
    -domainCred $creds `
    -DNSDelegationCred $creds `
    -NewADUserCred $creds
